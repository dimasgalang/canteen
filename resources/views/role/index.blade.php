                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-danger btn-circle btn-sm btn-delete-record" data-delete-link="delete/{{ $role->id }}" data-delete-name="{{ $role->name }}" data-toggle="modal" data-target="#deleteModal">
