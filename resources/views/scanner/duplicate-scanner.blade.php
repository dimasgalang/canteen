                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-auto mb-2">
                                            <button id='filter-data' type="button" class="btn btn-primary"><i
                                                    class="fas fa-search"></i> Filter</button>
                                        </div>
                                        <div class="col-auto mb-2">
                                            <button id='btn-bulk-move' type="button" class="btn btn-success" disabled><i
                                                    class="fas fa-exchange-alt"></i> Bulk Move to Canteen</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <span id="selected-count" class="badge badge-info" style="display:none;">0
                                        selected</span>
                                </div>
                                <div class="card-body">
